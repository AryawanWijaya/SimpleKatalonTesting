...
WebUI.setText(findTestObject('Object Repository/Page_Tokobuah Admin - Products/input_Name_name'), 'BambangBambangBambangBambangBambangBambangBambangBambangBambangBambangBambangBambangBambangBambangBambangBambangBambangBambangBambangBambangBambangBambangBambangBambangBambangBambangBambangBambangBambangBambangBambangBambangBambangBambangBambangBambangBam')

WebUI.setText(findTestObject('Object Repository/Page_Tokobuah Admin - Products/input_Price_price'), '10000')

WebUI.setText(findTestObject('Object Repository/Page_Tokobuah Admin - Products/textarea_Description_description'), 'ini kopi anggur merah')

WebUI.uploadFile(findTestObject('Page_Tokobuah Admin - Products/input_Photo_image'), 'C:\\Users\\AryawanWijaya\\Desktop\\Desain kaos JB\\600px-Ihs-logo.svg.PNG')
